...
/**
 * Strings for component 'assignsubmission_edusharing', language 'en'
 *
...
$string['maxfiles_help'] = 'So viele Dateien können pro Abgabe angenommen werden.';
$string['maxfilesreached'] = 'Es können maximal {$a} Dateien abgegeben werden.';
...
$string['selectedobjects'] = '{$a}: Ausgewählte Objekte';
