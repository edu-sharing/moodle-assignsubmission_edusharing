...
$string['maxfiles_help'] = 'Up to this number of files can be submitted.';
$string['maxfilesreached'] = 'A maximum of {$a} files can be submitted.';
...
$string['selectedobjects'] = '{$a}: Selected objects';
