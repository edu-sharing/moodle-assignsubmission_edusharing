...
namespace assignsubmission_edusharing\privacy;
...
class provider implements
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, 'assignsubmission_edusharing', ASSIGNSUBMISSION_FILE_FILEAREA);

        // Delete records from assignsubmission_file table.
        $DB->delete_records('assignsubmission_edusharing', ['assignment' => $requestdata->get_assign()->get_instance()->id]);
    }
